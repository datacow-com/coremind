...
async def test_smart_chunker_fixed(ingest_state):
    # Test Fixed Chunking
    ingest_state['strategy_config'] = {"chunking": {"mode": "fixed", "chunk_size": 100, "chunk_overlap": 0}}
...
async def test_smart_chunker_table_first(ingest_state):
    ...
    ingest_state['strategy_config'] = {"chunking": {"mode": "table_first", "chunk_size": 100, "chunk_overlap": 0}}
    chunker = SmartChunker()

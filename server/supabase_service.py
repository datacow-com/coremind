...
class SupabaseModelGatewayService:
    ...
    async def create_model(self, model_data: Dict[str, Any], user_id: str, user_name: str) -> Dict[str, Any]:
    ...
    async def list_models(self, filters: Dict[str, Any], page: int, page_size: int) -> Dict[str, Any]:
        return await self.repo.list_providers(filters, page, page_size)

    async def update_model(self, model_id: str, model_data: Dict[str, Any], user_id: str, user_name: str) -> Optional[Dict[str, Any]]:
    ...
    async def create_task_binding(self, binding_data: Dict[str, Any], user_id: str, user_name: str) -> Dict[str, Any]:
    ...
    # Credentials
    async def upsert_credentials(self, provider_id: str, env: str, data: Dict[str, Any], user_id: str, user_name: str) -> Dict[str, Any]:
    ...
    async def delete_credentials(self, provider_id: str, env: str, user_id: str, user_name: str) -> bool:
